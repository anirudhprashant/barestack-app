...
import { Card, Button, Icon, Select, Modal, Input } from '../components/ui';
import { Project, Task, TaskStatus, Creatable } from '../types';
            ...
            {selectedProject ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                 ...
                 <Card className="text-center p-12">
                    ...
                    <p className="mt-2 text-gray-500">Please select a project from the dropdown to view its tasks.</p>
                </Card>
            )}
